    ...
    public class SkillAbility : AbilityEntity
    {
        ...
        public Effect ParseEffect(string effectConfig)
        {
            ...
            if (!string.IsNullOrEmpty(effectConfig) && effectConfig.Contains("="))
            {
                ...
                {
                    var damageEffectConfig = SkillDamageEffectConfigCategory.Instance.Get(int.Parse(effectId));
                ...
                //{
                //    var addStatusEffectConfig = SkillAddStatusEffectConfigCategory.Instance.Get(int.Parse(effectId));
